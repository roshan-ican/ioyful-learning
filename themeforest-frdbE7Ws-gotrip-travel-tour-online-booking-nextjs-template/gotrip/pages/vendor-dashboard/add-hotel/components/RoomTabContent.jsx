    ...
    <div className="col-xl-9 col-lg-11">
      <div className="row x-gap-100 y-gap-15">
        <div className="col-12">
          <div className="text-18 fw-500">Room Type</div>
        </div>
        {/* End .col-12 */}
          ...
          <div className="row y-gap-15">
            <div className="col-12">
              <div className="d-flex items-center form-checkbox">
                ...
                <div className="text-15 lh-11 ml-10">Suite</div>
              </div>
            </div>
            {/* End .col-12 */}
            ...
            <div className="col-12">
              <div className="d-flex items-center form-checkbox">
                ...
                <div className="text-15 lh-11 ml-10">Family room</div>
              </div>
            </div>
            {/* End .col-12 */}
            ...
            <div className="col-12">
              <div className="d-flex items-center form-checkbox">
                ...
                <div className="text-15 lh-11 ml-10">Standard suite room</div>
              </div>
            </div>
            <div className="col-12">
              <div className="d-flex items-center form-checkbox">
                ...
                <div className="text-15 lh-11 ml-10">Honeymoon Suite</div>
              </div>
            </div>
            <div className="col-12">
              <div className="d-flex items-center form-checkbox">
                ...
                <div className="text-15 lh-11 ml-10">Business Suite</div>
              </div>
            </div>
            {/* End .col-12 */}
          </div>
