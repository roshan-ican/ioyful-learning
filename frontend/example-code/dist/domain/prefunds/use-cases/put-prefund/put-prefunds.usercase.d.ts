...
import { TransactionStatus, updatePrefundDTO } from '@/domain/prefunds/prefunds.schema';
declare const updateExistingPrefund: (transaction_id: string, updateData: updatePrefundDTO) => Promise<import("mongoose").Document<unknown, {}, {
